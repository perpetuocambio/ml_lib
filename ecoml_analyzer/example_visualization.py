...
def demo_ecological_visualization_integration():
    ...
    composition_fig = eco_viz.plot_composition_analysis(
        composition_results, site_names, title="Análisis de Composición Ecológica"
    )
    ...
    print(
        "✅ Demostración de integración ecológica con componentes generales completada"
    )
