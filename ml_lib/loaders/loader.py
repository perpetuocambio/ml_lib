...
from ..diffusion.generation.base import DiffusionConfig
from ..diffusion.generation.types import OptimizationLevel, SafetyLevel
...
class ConfigLoader:
    ...
    @staticmethod
    def to_file(
        config: DiffusionConfig, path: str | Path, format: str = "yaml"
    ) -> None:
