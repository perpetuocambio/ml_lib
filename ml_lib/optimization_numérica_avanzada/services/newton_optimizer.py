...
from ..models.optimization_models import NewtonConfig
...
class NewtonOptimizer(Optimizer):
    ...
    def _approximate_hessian(self, func: Callable, x: np.ndarray, grad: np.ndarray) -> np.ndarray:
        """
    ...
    def _line_search(self, func: Callable, x: np.ndarray, p: np.ndarray, 
                     grad: np.ndarray, c1: float = 1e-4, c2: float = 0.9) -> float:
        """
