"""Selected attributes model - replaces Dict[str, str] from generators."""

from dataclasses import dataclass
from typing import TYPE_CHECKING

if TYPE_CHECKING:
    from ml_lib.diffusion.intelligent.prompting.enhanced_attributes import AttributeDefinition
