...
from ml_lib.diffusion.generation.image_naming import ImageNamingConfig
from ml_lib.diffusion.prompt.prompt import PromptAnalysis, OptimizedParameters
from ml_lib.diffusion.generation.recommender_protocol import LoRARecommendation
...
class MemorySettings:
    ...
    def __post_init__(self):
        ...
        if self.offload_strategy not in ("none", "balanced", "aggressive"):
            raise ValueError(
                "offload_strategy must be 'none', 'balanced', or 'aggressive'"
            )
