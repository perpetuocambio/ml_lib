...
class ProcessedPrompt:
    ...
    def has_critical_loss(self) -> bool:
        ...
        """
        return any(
            t.priority == PromptTokenPriority.CRITICAL for t in self.removed_tokens
        )
    ...
    def has_high_priority_loss(self) -> bool:
        ...
        """
        return any(t.priority == PromptTokenPriority.HIGH for t in self.removed_tokens)
    ...
    def get_user_message(self, verbose: bool = False) -> str:
        ...
        parts.append(
            f"  • Tokens: {self.original_token_count} → {self.final_token_count}"
        )
