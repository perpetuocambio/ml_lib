"""Development configuration data types."""
...
class DevelopmentConfigData(BaseConfigData):
    """Type-safe container for development configuration data - replaces dict with typed classes."""
